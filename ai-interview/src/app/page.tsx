              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <input
                    ...
                    className="flex-1 px-5 py-4 border border-white/60 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all bg-white/70 backdrop-blur-sm shadow-sm text-gray-800 placeholder:text-gray-400"
                  />
                  <button
